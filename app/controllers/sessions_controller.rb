class SessionsController < ApplicationController
  ...
  def create_google
    ...
    if first_login
      ...
      redirect_to sync_start_path, flash: { success: 'Welcome to Attachments.io! We are syncing your emails and attachments for the last 2 weeks, and all future emails. For more information on syncing your emails from the beginning of time, <a href="http://attachments.io/contact/" target="_blank">please contact us</a>.<br><br><a href="https://mail.google.com/mail/u/0/#search/attachments.io" target="_blank">Please verify your account</a>.' }
    else
