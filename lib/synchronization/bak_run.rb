module Synchronization
  ...
  class RunBack
    ...
    def load_labels_and_emails
      ...
      @logger.debug "#{@user.email} Labels and mails ids was successful loaded. Time: #{Time.now - started} sec."
    end
    ...
    def load_folders_and_files
      ...
      if items.empty?
        ...
        @logger.debug "#{@user.email} Folders and files was successful processed. Time: #{Time.now - started} sec."
        return
      else
        folder = items.first
